...
(612) 554-6809 | Jacob.Larson55112@gmail.com | [github.com/j3nkii](https://github.com/j3nkii) | [linkedin.com/in/j3nkii](https://linkedin.com/in/j3nkii)

## About

Full-stack engineer who takes projects from concept to production. Built booking systems, Stripe integrations, and work order tools handling real transactions and workflows.

**Current Stack:** React, Node.js, SQL, AWS
...
**October 2021 – March 2022 | Minneapolis, MN**

- Completed 20-week full-stack engineering program with 400+ hours of hands-on development
- Solo project: Created top-down game with Phaser framework to explore state management and rendering logic
- Group project: Developed animal casting agency app with search, data management, and SQL optimization

**Technologies:** React, Redux, Sagas, Node.js, Express, PostgreSQL, Phaser